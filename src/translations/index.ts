...
export const translations = {
  ...
  he: {
    ...
    heroSubtitle: "עני על שאלון טיפוסי הכסף (Sacred Money Archetypes®) וגלי את סיפור הכסף שלך—כדי שתוכלי לעשות שינויים מדויקים, בטוחים ומותאמים בדיוק למי שאת באמת.",
    ...
    nextPoints: [
      "מלאי את השאלון (בערך 8-10 דקות) וגלי מיד את טיפוסי הכסף שלך",
