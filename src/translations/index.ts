export const translations = {
  ...
  he: {
    // Header
    hi: "היי, אני אורית אשל",
    
    // Hero Section
    heroTitle: "מה אם תרגישי טוב עם כסף -",
    heroTitleHighlight: "ועם עצמך?",
    heroSubtitle: "עני על שאלון טיפוסי הכסף (Sacred Money Archetypes®) וגלי מה בעצם עיצב את סיפור הכסף שלך—כדי שתוכלי לעשות שינויים מדויקים, בטוחים ומותאמים בדיוק למי שאת באמת.",
    takeQuiz: "👉 עברי לשאלון",
    
    // Personal Story
    storyTitle: "מספקות עצמים לרשות",
    storyP1: "שנים חיכיתי. למשהו. למישהי או מישהו או סימן שיגידו לי שאני מספיק טובה במה שאני עושה או רוצה לעשות ולהפסיק לנסות להיות מושלמת, להשתפר ואז באמת להתחיל.",
    storyP2: "דוקטורט, מלגות, שנים באקדמיה, אין-ספור קורסים, הסמכות, פודקאסטים, טיפולים מסוגים שונים... כל זה היה נפלא ומקדם. אבל הניצוץ הזה שאומר: \"הגעת. את מספיק. מותר לך לתפוס מקום, ולהרוויח כסף ממה שאת אוהבת\" לא יכול להגיע מאף אחד אחר.",
    storyP3: "רק כשהתחלתי לשחרר בושה, לבטוח באינטואיציה שלי ולהעז להגיד את מה שאני באמת רוצה, משהו באמת התחיל להשתנות.",
    storyP4: "לאחרונה למדתי את טיפוסי הכסף והם נתנו לי אישור למה שתמיד הרגשתי: שלהיות אידיאליסטית, יצירתית ואיכפתית זו מתנה ושזה בסדר גמור להרוויח כסף מזה. הם גם עזרו לי להבין שזו מתנה שזקוקה גם למבנה, תמיכה וביטחון, כדי לפרוח (ולהרוויח).",
    storyP5: "בכל דבר שעשיתי עזרתי תמיד למי שמסביבי לעבור מחשיבת יתר ומאבק לפשטות, חדוות יצירה וסיפוק ועכשיו אני עושה את זה בתחום הכסף. אני לא יועצת כלכלית או רואת חשבון אבל אני מומחית בלעזור לך לשחרר סיפורים ישנים ולשנות את כל הקשר שלך עם עצמך, עם העולם ועם כסף.",
    storyHighlight: "אם את כמהה לחיבור משמעותי, להשפעה, וליכולת לקבל כסף מתוך עשייה שמדליקה אותך—אני כאן איתך. 💛",
    storyClosing: "העולם צריך הרבה יותר כסף בידיים של נשים שאיכפת להן.",
    
    // Subheader
    subheaderTitle: "את לא צריכה להתאמץ יותר, לצמצם, או \"לתקן את עצמך\" כדי להרגיש טוב עם כסף.",
    subheaderSubtitle: "את רק צריכה להבין את הדפוסים העמוקים שפעלו מאחורי הקלעים ולהבין את עצמך יותר טוב ולהתחיל לפעול עם עצמך ולא נגדך.",
    ...
    // What You'll Learn
    learnTitle: "מה התוצאות יגלו לך:",
    learnPoints: [
      "✨ מה באמת מניע את ההחלטות שלך לגבי כסף ומה חוסם אותך",
      "✨ איך לעבור מתחושות של לחץ, אשמה או הימנעות לביטחון ובהירות",
      "✨ מהן החוזקות האמיתיות שלך ואיך להשתמש בהן בלי להישחק",
    ...
    nextPoints: [
      "קחי את השאלון (בערך 8-10 דקות) וגלי מיד את טיפוסי הכסף שלך",
      "תקבלי ממני הזמנה לקריאת הסיפור האישי שלך ללא עלות",
      "נגלה יחד שינויים קטנים שיכולים לשנות לגמרי את מערכת היחסים שלך עם כסף"
    ],
    startQuiz: "👉 עברי לשאלון",
    bookPersonality: "📅 קבעי פגישת קריאת מפת הכסף",
    bookCrack: "📞 קבעי שיחת \"פיצוח קוד הכסף\" שלך - כשעה ורבע, 111 יורו / 444 ש״ח",
